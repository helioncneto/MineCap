...
spSession = SparkSession.builder.master("local").appName("MineCap").config("spark.some.config.option",
...
def transformToNumeric2(inputStr):
    ...
    linhas = Row(classe=classe, srcip=srcip, srcport=srcport, dstip=dstip, dstport=dstport, proto=proto,
                 ...
                 std_fpktl=std_fpktl, min_bpktl=min_bpktl, mean_bpktl=mean_bpktl, max_bpktl=max_bpktl,
                 std_bpktl=std_bpktl,
