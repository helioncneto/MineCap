...
layers = [38, 5, 4, 2]
mlpClassifer = MultilayerPerceptronClassifier(labelCol = "rotulo", featuresCol = "scaledFeatures", maxIter=100, layers=layers, blockSize=128, seed=1234)
...
def output_rdd(rdd):
	...
	if not rdd.isEmpty():
		...
		predictions = modelo.transform(scaled_Data)
